...
"""rpush: An application that wraps the paramgmt.RemotePush function."""
...
def main(args):
  ...
  pmgmt = paramgmt.ParaMgmt(args.user, hosts, parallel, False,
                            color, args.attempts)
  ret = pmgmt.RemotePush(args.local, args.destination)
...
if __name__ == '__main__':
  ...
  parser.add_argument('local', nargs=argparse.REMAINDER,
