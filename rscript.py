...
"""rscript: An application that wraps the paramgmt.RemoteScript function."""
...
def main(args):
  ...
  pmgmt = paramgmt.ParaMgmt(args.user, hosts, parallel, False,
                            color, args.attempts)
  ret = pmgmt.RemoteScript(args.scripts)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(prog='rpush', description='remote push')
  ...
  parser.add_argument('scripts', nargs=argparse.REMAINDER,
                      help='Local scripts to run remotely')
