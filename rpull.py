...
"""rpull: An application that wraps the paramgmt.RemotePull function."""
...
def main(args):
  ...
  pmgmt = paramgmt.ParaMgmt(args.user, hosts, parallel, False,
                            color, args.attempts)
  ret = pmgmt.RemotePull(args.remote, args.destination)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(prog='rpull', description='remote pull')
  ...
  parser.add_argument('remote', nargs=argparse.REMAINDER,
