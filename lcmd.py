...
"""lcmd: An application that wraps the paramgmt.LocalCommand function."""
...
def main(args):
  ...
  pmgmt = paramgmt.ParaMgmt('unused', hosts, parallel, False,
                            color, args.attempts)
  ret = pmgmt.LocalCommand(args.commands)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(prog='lcmd', description='local commands')
